...
typedef struct storage
{
    ...
    /* ESP32-P4: set by h264bsdDecodeSliceData when the whole picture was one
     * skip run and is therefore a bit-exact copy of its reference — the
     * macroblock loop and the deblocking pass were not run (h264bsd_esp.h). */
    u32 espPicIsRefCopy;
} storage_t;
