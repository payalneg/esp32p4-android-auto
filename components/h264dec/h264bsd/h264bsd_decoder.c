...
#include "esp_timer.h"
u64 g_h264bsd_deblock_us;
#endif
u32 g_h264bsd_pic_version;
...
/* Variables */
    ...
    {
#ifdef H264BSD_ESP_FASTPATH
        g_h264bsd_pic_version = h264bsdDirtyEndPicture(pStorage->currImage->data);
        if (pStorage->espPicIsRefCopy)
        {
            /* bit-exact reference copy: nothing to filter */
            pStorage->espPicIsRefCopy = 0;
        }
        else
#endif
#ifdef H264BSD_ESP_STATS
        {
            ...
            g_h264bsd_deblock_us += (u64)(esp_timer_get_time() - t0);
        }
#else
        h264bsdFilterPicture(pStorage->currImage, pStorage->mb);
#endif
