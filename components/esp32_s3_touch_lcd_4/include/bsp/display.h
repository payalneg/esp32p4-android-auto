...
/* LCD display color bytes endianess. Little-endian: LVGL writes RGB565 in
 * native byte order (LV_COLOR_16_SWAP 0 in main/lv_conf.h) and the RGB panel
 * shifts the framebuffer out byte by byte, so no swap is involved. */
