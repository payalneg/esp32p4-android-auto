 ...
 */
typedef struct {
    unsigned int swap_xy;   /*!< Swap X and Y after reading coordinates */
    unsigned int mirror_x;  /*!< Mirror X after reading coordinates */
    unsigned int mirror_y;  /*!< Mirror Y after reading coordinates */
} bsp_touch_config_t;
