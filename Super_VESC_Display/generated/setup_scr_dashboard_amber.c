...
void setup_scr_dashboard_amber(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->dashboard_amber_uptime_text, 205, 5);
    ...
    lv_obj_set_pos(ui->dashboard_amber_power_value, 630, 75);
    lv_obj_set_size(ui->dashboard_amber_power_value, 112, 70);
    ...
    lv_obj_set_pos(ui->dashboard_amber_esc_not_connected_text, 280, 5);
    ...
    lv_obj_set_style_text_font(ui->dashboard_amber_esc_not_connected_text, &lv_font_DSEG14Classic_Regular_22, LV_PART_MAIN|LV_STATE_DEFAULT);
