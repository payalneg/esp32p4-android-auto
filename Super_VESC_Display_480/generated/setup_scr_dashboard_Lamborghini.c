...
void setup_scr_dashboard_Lamborghini(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->dashboard_Lamborghini, 480, 480);
    ...
    static lv_point_t dashboard_Lamborghini_frame_left[] = {{1, 1},{57, 1},{77, 49},{77, 428},{1, 428},};
    ...
    lv_obj_set_size(ui->dashboard_Lamborghini_frame_left, 79, 430);
    ...
    static lv_point_t dashboard_Lamborghini_frame_right[] = {{78, 1},{22, 1},{2, 49},{2, 428},{78, 428},};
    lv_line_set_points(ui->dashboard_Lamborghini_frame_right, dashboard_Lamborghini_frame_right, 5);
    lv_obj_set_pos(ui->dashboard_Lamborghini_frame_right, 401, 26);
    lv_obj_set_size(ui->dashboard_Lamborghini_frame_right, 79, 430);
    ...
    static lv_point_t dashboard_Lamborghini_accent_left[] = {{0, 3},{41, 3},};
    lv_line_set_points(ui->dashboard_Lamborghini_accent_left, dashboard_Lamborghini_accent_left, 2);
    lv_obj_set_pos(ui->dashboard_Lamborghini_accent_left, 79, 27);
    lv_obj_set_size(ui->dashboard_Lamborghini_accent_left, 42, 6);
    ...
    static lv_point_t dashboard_Lamborghini_accent_right[] = {{1, 3},{42, 3},};
    lv_line_set_points(ui->dashboard_Lamborghini_accent_right, dashboard_Lamborghini_accent_right, 2);
    lv_obj_set_pos(ui->dashboard_Lamborghini_accent_right, 359, 27);
    lv_obj_set_size(ui->dashboard_Lamborghini_accent_right, 42, 6);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_00, 55, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_00, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_01, 86, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_01, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_02, 117, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_02, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_03, 148, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_03, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_04, 179, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_04, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_05, 211, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_05, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_06, 242, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_06, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_07, 273, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_07, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_08, 304, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_08, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_09, 335, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_09, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_10, 367, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_10, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_seg_11, 398, 7);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_seg_11, 29, 5);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_batt, 6, 74);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_batt, 67, 78);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_volt, 6, 163);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_volt, 67, 64);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_amp, 6, 238);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_amp, 67, 64);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_batt_lbl, 14, 84);
    lv_obj_set_size(ui->dashboard_Lamborghini_batt_lbl, 54, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_Battery_proc_text, 14, 98);
    lv_obj_set_size(ui->dashboard_Lamborghini_Battery_proc_text, 54, 38);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_batt_bar, 14, 138);
    lv_obj_set_size(ui->dashboard_Lamborghini_batt_bar, 53, 3);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_volt_lbl, 14, 173);
    lv_obj_set_size(ui->dashboard_Lamborghini_volt_lbl, 54, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_Voltage_text, 14, 187);
    lv_obj_set_size(ui->dashboard_Lamborghini_Voltage_text, 70, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_amp_lbl, 14, 248);
    lv_obj_set_size(ui->dashboard_Lamborghini_amp_lbl, 54, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_Current_text, 14, 262);
    lv_obj_set_size(ui->dashboard_Lamborghini_Current_text, 105, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_tmot, 407, 74);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_tmot, 67, 66);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_tfet, 407, 151);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_tfet, 67, 66);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_range, 407, 228);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_range, 67, 66);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_tmot_lbl, 413, 84);
    lv_obj_set_size(ui->dashboard_Lamborghini_tmot_lbl, 54, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_temp_mot_text, 407, 98);
    lv_obj_set_size(ui->dashboard_Lamborghini_temp_mot_text, 50, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_temp_mot_unit, 459, 98);
    lv_obj_set_size(ui->dashboard_Lamborghini_temp_mot_unit, 17, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_tfet_lbl, 413, 161);
    lv_obj_set_size(ui->dashboard_Lamborghini_tfet_lbl, 54, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_temp_esc_text, 407, 175);
    lv_obj_set_size(ui->dashboard_Lamborghini_temp_esc_text, 50, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_temp_esc_unit, 459, 175);
    lv_obj_set_size(ui->dashboard_Lamborghini_temp_esc_unit, 17, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_range_lbl, 413, 238);
    lv_obj_set_size(ui->dashboard_Lamborghini_range_lbl, 54, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_Range_text, 381, 252);
    lv_obj_set_size(ui->dashboard_Lamborghini_Range_text, 70, 36);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_range_unit, 452, 266);
    lv_obj_set_size(ui->dashboard_Lamborghini_range_unit, 16, 16);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_vesc, 6, 318);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_vesc, 67, 46);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_status_vesc, 6, 331);
    lv_obj_set_size(ui->dashboard_Lamborghini_status_vesc, 67, 22);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_card_settings, 407, 318);
    lv_obj_set_size(ui->dashboard_Lamborghini_card_settings, 67, 46);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_Settings_text, 406, 331);
    lv_obj_set_size(ui->dashboard_Lamborghini_Settings_text, 70, 22);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_meter, 74, 80);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_Speed_text, 150, 161);
    lv_obj_set_size(ui->dashboard_Lamborghini_Speed_text, 180, 145);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_speed_unit, 150, 288);
    lv_obj_set_size(ui->dashboard_Lamborghini_speed_unit, 180, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_power_value, 170, 336);
    lv_obj_set_size(ui->dashboard_Lamborghini_power_value, 67, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_power_unit, 240, 336);
    lv_obj_set_size(ui->dashboard_Lamborghini_power_unit, 36, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_flow_regen_lbl, 114, 396);
    lv_obj_set_size(ui->dashboard_Lamborghini_flow_regen_lbl, 72, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_flow_power_lbl, 294, 396);
    lv_obj_set_size(ui->dashboard_Lamborghini_flow_power_lbl, 72, 14);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_power_bar, 114, 415);
    lv_obj_set_size(ui->dashboard_Lamborghini_power_bar, 252, 9);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_flow_center, 240, 413);
    ...
    lv_obj_set_size(ui->dashboard_Lamborghini_bottom_bar, 480, 44);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_led_tt_cruise_lbl, 10, 451);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_tt_cruise_lbl, 24, 452);
    lv_obj_set_size(ui->dashboard_Lamborghini_tt_cruise_lbl, 22, 13);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_led_tt_fault_lbl, 48, 451);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_tt_fault_lbl, 61, 452);
    lv_obj_set_size(ui->dashboard_Lamborghini_tt_fault_lbl, 22, 13);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_led_status_bt, 85, 451);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_status_bt, 98, 452);
    lv_obj_set_size(ui->dashboard_Lamborghini_status_bt, 22, 13);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_trip_lbl, 228, 444);
    lv_obj_set_size(ui->dashboard_Lamborghini_trip_lbl, 36, 13);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_TRIP_text, 228, 457);
    lv_obj_set_size(ui->dashboard_Lamborghini_TRIP_text, 20, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_trip_unit, 250, 457);
    lv_obj_set_size(ui->dashboard_Lamborghini_trip_unit, 18, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_odo_lbl, 286, 444);
    lv_obj_set_size(ui->dashboard_Lamborghini_odo_lbl, 36, 13);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_odo_text, 286, 457);
    lv_obj_set_size(ui->dashboard_Lamborghini_odo_text, 33, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_odo_unit, 316, 457);
    lv_obj_set_size(ui->dashboard_Lamborghini_odo_unit, 18, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_mode_text, 347, 450);
    lv_obj_set_size(ui->dashboard_Lamborghini_mode_text, 60, 18);
    ...
    lv_obj_set_pos(ui->dashboard_Lamborghini_cur_time_label, 413, 447);
    lv_obj_set_size(ui->dashboard_Lamborghini_cur_time_label, 54, 22);
