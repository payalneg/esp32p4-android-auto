...
class IpcCmd {
  ...
  static const navFound = 'navFound'; // {hits: [{lat, lon, name}]} → {ack}
...
class IpcEvt {
  ...
  /// The head unit's tile store is empty — everything must be sent again.
  static const navEmptied = 'navEmptied';
