...
const _en = <String, String>{
  ...
  // --- offline navigator ---
  'nav.title': 'Navigator',
  'nav.search.hint': 'Street, address or place',
  'nav.search.empty': 'Nothing found',
  'nav.search.noindex': 'No search index — download the map data',
  'nav.profile': 'Ride profile',
  'nav.profile.bicycle': 'Bicycle',
  'nav.profile.scooter': 'Scooter',
  'nav.profile.sidewalks': 'Pavements only',
  'nav.profile.calm': 'Quiet route',
  'nav.route.mode': 'Pick route points',
  'nav.route.tapStart': 'Tap the start',
  'nav.route.tapFinish': 'Tap the destination',
  'nav.route.routing': 'Building the route…',
  'nav.route.notFound': 'No route found',
  'nav.route.summary': '{km} km · ~{min} min · pavements {pct}%',
  'nav.route.reset': 'Clear the route',
  'nav.route.fromHere': 'Route from my location',
  'nav.route.setStart': 'Set as start',
  'nav.route.setFinish': 'Set as destination',
  'nav.guide.offRoute': 'Off route',
  'nav.guide.arrived': 'You have arrived',
  'nav.guide.remaining': '{km} km · ~{min} min left',
  'nav.dist.m': '{n} m',
  'nav.dist.km': '{n} km',
  'nav.maneuver.straight': 'Straight on',
  'nav.maneuver.slightLeft': 'Bear left',
  'nav.maneuver.slightRight': 'Bear right',
  'nav.maneuver.turnLeft': 'Turn left',
  'nav.maneuver.turnRight': 'Turn right',
  'nav.maneuver.sharpLeft': 'Sharp left',
  'nav.maneuver.sharpRight': 'Sharp right',
  'nav.maneuver.uturn': 'Make a U-turn',
  'nav.maneuver.arrive': 'Destination',
  'nav.sim.start': 'Simulate the ride',
  'nav.sim.stop': 'Stop the simulation',
  'nav.sim.needRoute': 'Build a route first',
  'nav.follow': 'Follow my position',
  'nav.gps.off': 'Location is switched off',
  'nav.gps.denied': 'Location permission denied',
  'nav.gps.deniedForever': 'Allow location in system settings',
  'nav.gps.openSettings': 'Open settings',
  'nav.gps.waiting': 'Waiting for a GPS fix…',
  'nav.search.coordinates': 'Coordinates',
  'nav.link.kind': 'From a link',
  'nav.link.bad': 'Could not read that map link',
  'nav.link.resolving': 'Opening the link…',
  'nav.link.notFound': 'Nothing found for “{q}”',
  'nav.start': 'Start',
  'nav.stop': 'End navigation',
  'nav.trackUp': 'Heading up',
  ...
  'nav.say.prepare': 'In {dist}, {action}',
  'nav.say.metres': '{n} metres',
  'nav.say.arriveSoon': 'In {dist} you reach your destination',
  'nav.say.arrived': 'You have arrived',
  'nav.say.rerouting': 'Off route. Rerouting',
  'nav.say.act.straight': 'continue straight',
  'nav.say.act.slightLeft': 'bear left',
  'nav.say.act.slightRight': 'bear right',
  'nav.say.act.turnLeft': 'turn left',
  'nav.say.act.turnRight': 'turn right',
  'nav.say.act.sharpLeft': 'turn sharp left',
  'nav.say.act.sharpRight': 'turn sharp right',
  'nav.say.act.uturn': 'make a U-turn',
  ...
  'settings.mapdata.title': 'Map data',
  'settings.mapdata.subtitle.none': 'Not downloaded',
  ...
  'mapdata.status.loading': 'Building the graph…',
  'mapdata.status.ready': '{nodes} junctions, {edges} roads ({mb} MB)',
  'mapdata.status.places': '{places} searchable places',
  'mapdata.status.noplaces': 'No search index',
  'mapdata.delete': 'Delete map data',
  'mapdata.delete.confirm': 'Delete the downloaded graph and search index?',
  'mapdata.err.http': 'Server returned {code}',
  'mapdata.err.download': 'Download failed: {err}',
  ...
  'mapdata.tiles.progress':
      'Saving the map… {done} of {total} tiles · {mb} MB · {rate}',
  'mapdata.tiles.rateMb': '{n} MB/s',
  'mapdata.tiles.rateKb': '{n} KB/s',
  'mapdata.tiles.title': 'Map tiles',
  'mapdata.tiles.size': '{mb} MB in {n} tiles',
  'mapdata.tiles.empty': 'Nothing cached yet',
  'mapdata.tiles.clear': 'Clear the tile cache',
  'mapdata.tiles.clear.confirm': 'Delete every cached map tile?',
  'mapdata.tiles.cap': 'Cache limit',
  'mapdata.corridor': 'Save the route for offline use',
  'mapdata.corridor.progress': 'Tiles {done}/{total}',
  'mapdata.corridor.done': 'Saved {n} tiles along the route',
  'mapdata.corridor.needRoute': 'Build a route first',
...
const _ru = <String, String>{
  ...
  // --- offline navigator ---
  'nav.title': 'Навигатор',
  'nav.search.hint': 'Улица, адрес или место',
  'nav.search.empty': 'Ничего не найдено',
  'nav.search.noindex': 'Нет поискового индекса — скачайте данные карты',
  'nav.profile': 'Профиль поездки',
  'nav.profile.bicycle': 'Велосипед',
  'nav.profile.scooter': 'Самокат',
  'nav.profile.sidewalks': 'Только тротуары',
  'nav.profile.calm': 'Спокойный',
  'nav.route.mode': 'Выбрать точки маршрута',
  'nav.route.tapStart': 'Коснитесь начала',
  'nav.route.tapFinish': 'Коснитесь конца',
  'nav.route.routing': 'Строю маршрут…',
  'nav.route.notFound': 'Маршрут не найден',
  'nav.route.summary': '{km} км · ~{min} мин · тротуары {pct}%',
  'nav.route.reset': 'Сбросить маршрут',
  'nav.route.fromHere': 'Маршрут отсюда',
  'nav.route.setStart': 'Сделать началом',
  'nav.route.setFinish': 'Сделать концом',
  'nav.guide.offRoute': 'Сход с маршрута',
  'nav.guide.arrived': 'Вы на месте',
  'nav.guide.remaining': 'осталось {km} км · ~{min} мин',
  'nav.dist.m': '{n} м',
  'nav.dist.km': '{n} км',
  'nav.maneuver.straight': 'Прямо',
  'nav.maneuver.slightLeft': 'Плавно налево',
  'nav.maneuver.slightRight': 'Плавно направо',
  'nav.maneuver.turnLeft': 'Налево',
  'nav.maneuver.turnRight': 'Направо',
  'nav.maneuver.sharpLeft': 'Резко налево',
  'nav.maneuver.sharpRight': 'Резко направо',
  'nav.maneuver.uturn': 'Разворот',
  'nav.maneuver.arrive': 'Прибытие',
  'nav.sim.start': 'Проиграть поездку',
  'nav.sim.stop': 'Остановить проигрывание',
  'nav.sim.needRoute': 'Сначала постройте маршрут',
  'nav.follow': 'Следить запозицией',
  'nav.gps.off': 'Геолокация выключена',
  'nav.gps.denied': 'Доступ к геолокации не разрешён',
  'nav.gps.deniedForever': 'Разрешите геолокацию в настройках системы',
  'nav.gps.openSettings': 'Открыть настройки',
  'nav.gps.waiting': 'Жду сигнал GPS…',
  'nav.search.coordinates': 'Координаты',
  'nav.link.kind': 'Из ссылки',
  'nav.link.bad': 'Не понял ссылку на карту',
  'nav.link.resolving': 'Открываю ссылку…',
  'nav.link.notFound': 'Ничего не нашёл по «{q}»',
  'nav.start': 'Поехали',
  'nav.stop': 'Завершить',
  'nav.trackUp': 'Карта по курсу',
  ...
  'nav.say.prepare': 'Через {dist} {action}',
  'nav.say.metres': '{n} метров',
  'nav.say.arriveSoon': 'Через {dist} вы на месте',
  'nav.say.arrived': 'Вы на месте',
  'nav.say.rerouting': 'Сход с маршрута. Перестраиваю',
  'nav.say.act.straight': 'продолжайте прямо',
  'nav.say.act.slightLeft': 'держитесь левее',
  'nav.say.act.slightRight': 'держитесь правее',
  'nav.say.act.turnLeft': 'поверните налево',
  'nav.say.act.turnRight': 'поверните направо',
  'nav.say.act.sharpLeft': 'резко налево',
  'nav.say.act.sharpRight': 'резко направо',
  'nav.say.act.uturn': 'развернитесь',
  ...
  'settings.mapdata.title': 'Данные карты',
  'settings.mapdata.subtitle.none': 'Не загружены',
  ...
  'mapdata.status.loading': 'Строю граф…',
  'mapdata.status.ready': '{nodes} перекрёстков, {edges} дорог ({mb} МБ)',
  'mapdata.status.places': '{places} мест для поиска',
  'mapdata.status.noplaces': 'Поискового индекса нет',
  'mapdata.delete': 'Удалить данные карты',
  'mapdata.delete.confirm': 'Удалить скачанный граф и поисковый индекс?',
  'mapdata.err.http': 'Сервер ответил {code}',
  'mapdata.err.download': 'Не удалось скачать: {err}',
  ...
  'mapdata.tiles.progress':
      'Сохраняю карту… {done} из {total} · {mb} МБ · {rate}',
  'mapdata.tiles.rateMb': '{n} МБ/с',
  'mapdata.tiles.rateKb': '{n} КБ/с',
  'mapdata.tiles.title': 'Тайлы карты',
  'mapdata.tiles.size': '{mb} МБ в {n} тайлах',
  'mapdata.tiles.empty': 'Кэш пуст',
  'mapdata.tiles.clear': 'Очистить кэш тайлов',
  'mapdata.tiles.clear.confirm': 'Удалить все сохранённые тайлы карты?',
  'mapdata.tiles.cap': 'Лимит кэша',
  'mapdata.corridor': 'Сохранить маршрут для офлайна',
  'mapdata.corridor.progress': 'Тайлы {done}/{total}',
  'mapdata.corridor.done': 'Сохранено {n} тайлов вдоль маршрута',
  'mapdata.corridor.needRoute': 'Сначала постройте маршрут',
...
///
/// Non-widget layers hand the UI a key plus arguments rather than built-up
/// text, so a message composed in a service still comes out in the reader's
/// language (see firmware/firmware_updater.dart for the original of this
/// pattern).
String tf(BuildContext context, String key, Map<String, Object?> args) {
