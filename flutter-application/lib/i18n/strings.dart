...
const _en = <String, String>{
  ...
  'nav.data.missing.action': 'Download',
  ...
  'mapdata.server': 'Data server',
  'mapdata.server.hint': 'http://192.168.1.10:8000/',
  'mapdata.server.help':
      'Serve the generated files with: cd scripts/mapgen/vtiles && python3 -m http.server 8000',
  'mapdata.download': 'Download',
  'mapdata.downloading': '{file} — {pct}%',
  ...
  'mapdata.status.loading': 'Loading…',
  ...
  'mapdata.err.noUrl': 'Enter the address of the data server',
  'mapdata.err.badUrl': 'Not a valid address: {url}',
...
const _ru = <String, String>{
  ...
  'nav.data.missing.action': 'Скачать',
  ...
  'mapdata.server': 'Сервер данных',
  'mapdata.server.hint': 'http://192.168.1.10:8000/',
  'mapdata.server.help':
      'Раздать собранные файлы: cd scripts/mapgen/vtiles && python3 -m http.server 8000',
  ...
  'mapdata.status.loading': 'Загружаю…',
  ...
  'mapdata.err.noUrl': 'Укажите адрес сервера данных',
  'mapdata.err.badUrl': 'Неверный адрес: {url}',
